  ...
  return (
    <section id="portfolio" className="relative overflow-hidden bg-background py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        {/* Section Header */}
        <div className="reveal flex flex-col items-start justify-between gap-6 md:flex-row md:items-end mb-16">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary shadow-soft">
          ...
          <p className="text-base text-foreground/70 md:max-w-md leading-relaxed">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((p, i) => (
            <article
              key={p.title}
              className="reveal card-tilt group flex flex-col overflow-hidden rounded-3xl border border-border bg-surface/60 backdrop-blur-sm transition-smooth hover:-translate-y-1.5 hover:border-primary/40 hover:shadow-card"
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-border bg-background px-4 py-3">
                ...
                <div className="flex items-center gap-1.5 rounded-md bg-surface px-2.5 py-0.5 text-[11px] font-mono text-foreground/60 border border-border">
                  <Globe size={11} className="text-primary" />
                  <span className="truncate max-w-[150px]">{p.domain}</span>
                </div>
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-muted/40 border-b border-border">
                ...
                <div className="absolute left-3 top-3">
                  <span className={`inline-flex items-center gap-1 rounded-full border px-3 py-1 text-[11px] font-bold backdrop-blur-md shadow-sm ${p.accentColor}`}>
                    {p.category}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col justify-between p-6 md:p-7">
                <div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {p.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-lg border border-border bg-background/80 px-2.5 py-1 text-[10px] font-medium text-foreground/70"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="mt-6 pt-5 border-t border-border/80 flex items-center justify-between">
                  <a
                    ...
                    className="group/link inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-xs font-bold text-primary transition-smooth hover:bg-primary hover:text-primary-foreground shadow-soft"
                  >
        ...
        <div className="reveal mt-16 rounded-3xl border border-border bg-surface/50 p-8 md:p-10 shadow-soft">
          <div className="grid gap-6 md:grid-cols-3 items-center text-center md:text-left">
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <div>
                <div className="font-bold text-foreground text-sm">100% Custom Engineered</div>
                <div className="text-xs text-foreground/60">No generic templates or bloat</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <div>
                <div className="font-bold text-foreground text-sm">Sub-second Page Speeds</div>
                <div className="text-xs text-foreground/60">Optimized for maximum conversion</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 justify-center md:justify-start">
              ...
              <div>
                <div className="font-bold text-foreground text-sm">Post-Launch Support</div>
                <div className="text-xs text-foreground/60">Continuous maintenance &amp; updates</div>
              </div>
            </div>
          </div>
        </div>
